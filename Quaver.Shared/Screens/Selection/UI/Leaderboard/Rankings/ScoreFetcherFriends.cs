...
{
    /// <summary>
    ///     Fetches scores for <see cref="LeaderboardType.Friends"/> using API v2.
    /// </summary>
    public class ScoreFetcherFriends : IScoreFetcher
    {
        public FetchedScoreStore Fetch(Map map, CancellationToken token = default)
        {
            try
            {
                ...
                var onlineScoresTask = System.Threading.Tasks.Task.Run(() => client.RetrieveScoreboardV2(map.Md5Checksum, OnlineScoreboard.Friends));
