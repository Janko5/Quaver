...
namespace Quaver.Shared.Graphics.Backgrounds
{
    ...
    public class BackgroundParticleSystem : Sprite
    {
        ...
        public BackgroundParticleSystem(int particleCount = 315)
        {
        ...
        /// <summary>
        ///     Returns a random particle color (50% light, 50% blue).
        /// </summary>
        private Color GetRandomParticleColor()
        {
            // 50% light (#D9E3F4), 50% blue (#1FBBFF)
            if (random.NextDouble() < 0.5)
                return new Color(217, 227, 244); // Light
            else
                return new Color(31, 187, 255);  // Blue
        }
